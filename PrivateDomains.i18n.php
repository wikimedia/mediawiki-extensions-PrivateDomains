...
$messages['br'] = array(
	...
	'right-privatedomains' => 'Merañ an domanioù prevez',
);
 ...
 */
$messages['fa'] = array(
	'privatedomains-nomanageaccess' => 'شما حق کافی برای ادارهٔ دامنه‌های خصوصی اجازه داده شده برای این ویکی را ندارید. 
تنها مأمور اداری و اعضای کارمند دسترسی دارند.

اگر شما وارد سامانه نشده‌اید، احتمالاً [[Special:UserLogin|باید]] بشوید.',
	'privatedomains' => 'مدیریت دامنه‌های خصوصی',
	'privatedomains-ifemailcontact' => 'در غیر این صورت، اگر هرگونه سوالی دارید با [[Special:EmailUser/$1|$1]] لطفاً تماس بگیرید.',
	'saveprivatedomains-success' => 'تغییرات دامنه‌های خصوصی دخیره شد.',
	'privatedomains-invalidemail' => 'با عرص پوزش، دسترسی به این ویکی برای اعضا $1 محدود شده‌است.
اگر شما آدرس رایانامه وابسته به $1 دارید، شما می‌توانید به آدرس رایانامه در [[Special:Preferences|صفحهٔ اولویت‌های حساب]]خود وارد شوید یا دوباره مورد تأیید قرار گیرید. 
شما هنوز می‌توانید صفحات را در ویکی مشاهده کنید، اما شما قادر به ویرایش نخواهید بود.',
	'privatedomains-affiliatenamelabel' => 'نام سازمان:',
	'privatedomains-emailadminlabel' => 'تماس نام کاربری برای دسترسی مشکلات یا پرسش‌ها:',
	'privatedomains-instructions' => 'در زیر فهرست دامنه‌های رایانامه مجاز برای ویرایشگران این ویکی وجود دارد.
هر خط یک پسوند رایانامه‌ای که برای ویرایش دسترسی داده‌است، معین شده‌است.
این باید با یک پسوند در هر خط قالب‌بندی شود.
به عنوان مثال:<div style="width: 20%; padding:5px; border: 1px solid grey;">cs.stanford.edu<br />stanfordalumni.org</div>
این به ویرایش‌های هر‌کس با آدرس رایانامه whatever@cs.stanford.edu یا whatever@stanfordalumni.org اجازه می‌دهد.
<b>دامنه‌های مجاز را در جعبهٔ متن زیر وارد کنید، و دکمهٔ "ذخیره" را کلیک کنید.</b>',
 ...
 */
$messages['ko'] = array(
	'privatedomains-nomanageaccess' => '이 위키의 허용된 개인 도메인을 관리할 권한이 부족합니다.

로그인 상태가 아니라면[[Special:UserLogin|로그인]]을 해주세요.',
	'privatedomains' => '개인 도메인 관리',
	'privatedomains-ifemailcontact' => '질문이 있으면 [[Special:EmailUser/$1|$1]] 사용자에게 문의해 주세요.',
	'saveprivatedomains-success' => '개인 도메인 바뀜이 저장됨.',
	'privatedomains-invalidemail' => '죄송합니다. 이 위키에 접근 할 수 있는 사용자는 $1 구성원으로 제한하고 있습니다.
$1와 연결된 이메일 주소를 갖고 있다면 [[Special:Preferences|계정 환경 설정 페이지]]에서 당신의 이메일 주소를 입력하거나 다시 확인할 수 있습니다.',
	'privatedomains-affiliatenamelabel' => '조직 이름:',
	'privatedomains-emailadminlabel' => '접속 문제 및 쿼리 때문에 사용자이름에 문의하기:',
	'privatedomains-instructions' => '아래는 이 위키의 편집자에게 허용된 이메일 도메인 목록입니다.
각각의 줄은 편집에 대해 주어진 이메일의 접미사를 나타냅니다.
한 줄에 하나의 접미사로 형식이 설정되어 있습니다.
예시: <div style="width: 20%; padding:5px; border: 1px solid grey;">cs.stanford.edu<br />stanfordalumni.org</div>
이 설정은 whatever@cs.stanford.edu or whatever@stanfordalumni.org 등의 이메일 주소를 가진 모든 사람의 편집을 허용합니다.
<b>텍스트 상자에 허용된 도메인을 입력하고 "저장"을 클릭하세요.</b>',
 ...
 */
$messages['ksh'] = array(
	'privatedomains-nomanageaccess' => 'Do häs nit et Rääsch, prevaate <i lang="en">Domains</i> em Wiki ze verwallde sowie zu verwalten. Bloß de Metmaaacher mem Rääsch <code lang="en">privatedomains</code> künne dat.

Wann De bloß nit enjelogg bes, [[Special:UserLogin|donn dat]] eijfach.',
	'privatedomains' => 'Deiht prevaate <i lang="en">Domains</i> verwallde.',
	'privatedomains-ifemailcontact' => 'Bei froore, donn Desch söns aan {{GENDER:$1|der Metmaacher}} [[Special:EmailUser/$1|$1]] wände.',
	'saveprivatedomains-success' => 'De Änderonge an de prevaate <i lang="en">Domains</i> sen faßjehallde.',
	'privatedomains-invalidemail' => 'Der Zohjang op heh dat Wiki es beschrängk op Lück med_ene Adräß för de <i lang="en">e-mail</i> onger dä <i lang="en">Domains</i> <code>$1</code>.

Wann De en <i lang="en">e-mail</i>-Adräß onger dä <i lang="en">Domains</i> häs, kanns De se op dä [[Special:Preferences|{{int:specialpage}} för de Enschtällonge]] aanjävve un beschtäätejje.
Do kanns suu udder esuu Sigge em Wiki beloore, si ävver nit verändere.',
	'privatedomains-affiliatenamelabel' => 'Dä Nahme vun dä Ojanisazjuhn:',
	'privatedomains-emailadminlabel' => 'Dem Metmaacher singe Nahme, dä bei Probleeme un Froore aanjeschrevve weed:',
	'privatedomains-instructions' => 'Heh dronger küdd_en Leß met de <i lang="en">Domains</i> vun <i lang="en">e-mail</i>-Adräße för de Metmaacher met dem Rääsch, en heh däm Wiki ze schriive.
En jeede Reih schteid_et Ängk (dat Schtöck henger_em „@“) för en <i lang="en">e-mail</i>-Adräß, di der Zohjang zum Schriive kritt.
Et sullt met einem esu eenm Schtöck en jeede Reih famateetert sin.
För e Beischpell:<div style="width: 20%; padding:5px; border: 1px solid grey;" lang="en">xyzzy.example.org<br />alumni.example.org</div>
Dat sullt jeedem med ene Adräß en Aat vun
<code><span lang="en">sönsjät</span><span lang="en">sönsjät@xyzzy.example.org</span></code>
<code><span lang="en">sönsjät</span><span lang="en">wääochemmer@alumni.example.org</span></code>
et Ändere älaube.
<b>Draach de <i lang="en">Domains</i> onge en, un donn dann op „{{int:save}}“ klecke.</b>',
	'right-privatedomains' => 'Prevaate <i lang="en">Domains</i> verwallde',
);
 ...
 */
$messages['mk'] = array(
	'privatedomains-nomanageaccess' => 'Жалиме, немате доволно права за да раководите со дозволените лични домени за ова вики. Само вики-бирократи и членови на персоналот имаат таков пристап.Ако не сте најавени, веројатно ќе [[Special:UserLogin|треба да се најавите]].',
	'privatedomains' => 'Раководење со лични домени',
	'privatedomains-ifemailcontact' => 'Во спротивно, обратете се на [[Special:EmailUser/$1|$1]] ако имате било какви прашања.',
	'saveprivatedomains-success' => 'Промените во личните домени се зачувани.',
 ...
 */
$messages['uk'] = array(
	'privatedomains-nomanageaccess' => 'У Вас недостатньо прав для керування приватними доменами цієї вікі.
Тільки вікі-бюрократи і працівники мають доступ.

Якщо Ви не увійшли в систему, то Вам, вочевидь, [[Special:UserLogin|варто]].',
	'privatedomains' => 'Керування приватними доменами',
	'privatedomains-ifemailcontact' => "В іншому випадку, будь ласка, зв'яжіться з [[Special:EmailUser/$1|$1]], якщо у Вас є які-небудь питання.",
	'saveprivatedomains-success' => 'Зміни у приватних доменах збережені.',
	'privatedomains-invalidemail' => "Вибачте, доступ до цієї вікі є лише у членів $1.
Якщо у Вас є адреса електронної пошти, пов'язаний з $1, Ви можете ввести або підтвердити Вашу адресу електронної пошти на своїй [[Special:Preferences|сторінці налаштувань]].
Ви можете переглядати сторінки цієї вікі, але не зможете редагувати.",
	'privatedomains-affiliatenamelabel' => 'Назва організації:',
	'privatedomains-emailadminlabel' => "Ім'я контактного користувача щодо питань або проблем з доступом:",
	'privatedomains-instructions' => 'Нижче наведено перелік поштових доменів, допустимих для редакторів цієї вікі.
Кожен рядок позначає суфікс адреси електронної пошти, якому надано доступ до редагування.
У кожному рядку має бути не більше одного суфікса.
Наприклад:<div style="width: 20%; padding:5px; border: 1px solid grey;">cs.stanford.edu<br />stanfordalumni.org</div>
Це дозволить редагувати комусь із адресою електронної поштиwhatever@cs.stanford.edu або whatever@stanfordalumni.org
